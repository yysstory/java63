...
- 화면에서 링크 클릭
- 입력폼을 값을 기본 메서드로 전송할 때

2) GET 요청에서 데이터 전송
- 요청라인의 URL에 포함한다.
- 예)
GET http://192.168.0.32:1337/?userid=ohora&pwd=1111okok HTTP/1.1
...
- 대용량 데이터 전송 가능. 서버에서 크기를 제한하지 않는 한에서는 
  무제한으로 데이터를 전송할 수있다. => 게시물 등록, 로그인 등
...
Connection: keep-alive
Content-Length: 7777
Content-Type: multipart/form-data; boundary=----WebKitFormBoundaryJEKHNoqWZQH0iBC8
...
(엔터)
------WebKitFormBoundaryJEKHNoqWZQH0iBC8
...
...
------WebKitFormBoundaryJEKHNoqWZQH0iBC8-- (끝)
